...
class DPMSolverScheduler(BaseScheduler):
    ...
    def inverse_lambda(self, lamb):
        ...
        t_array = (
            torch.linspace(0, 1, self.num_train_timesteps + 1)[1:]
            .reshape(1, -1)
            .to(log_alpha_array)
        )
    ...
    def second_order_step(
        self, x_ti1, t_i1, t_i, eps_theta, guidance_scale, class_label
    ):
        """
        ...
        Input:
            ...
            guidance_scale (float): the scale of CFG
            class_label (`torch.Tensor`): condition input to the network.
        Output:
    ...
    def step(
        ...
        Input:
            ...
            guidance_scale (optional, float): Usd for seocnd-order scheduling.
            class_label (optional, `torch.Tensor`): Used for second-order scheduling.
        Ouptut:
        ...
        if order == 1:
            ...
            sample_prev = self.second_order_step(
                x_t,
                t,
                t_prev,
                eps_theta,
